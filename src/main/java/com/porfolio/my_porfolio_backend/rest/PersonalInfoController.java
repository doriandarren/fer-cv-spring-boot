package com.porfolio.my_porfolio_backend.rest;
...
import com.porfolio.my_porfolio_backend.services.IPersonalInfoService;
...
public class PersonalInfoController {
    ...
    @PostMapping("/store")
    public ResponseEntity<PersonalInfo> store(PersonalInfo personalInfo) {
